...
var search =  data.SECTION_SEARCH_RESULT

// for loop
for(let i=0;i<search.length;i++) {
    console.log("Name: ",search[i].info.name);
    console.log("Rating: ",search[i].info.rating.aggregate_rating);
    console.log("Cost per person: ",search[i].info.cfo.text);
    console.log("Distance: ",search[i].distance);
    console.log("");
}

// for in loop
for(let x in search){
    console.log("Name: ",search[x].info.name);
    console.log("Rating: ",search[x].info.rating.aggregate_rating);
    console.log("Cost per person: ",search[x].info.cfo.text);
    console.log("Distance: ",search[x].distance);
    console.log("");
}

// for of loop
for(let key of data.SECTION_SEARCH_RESULT){
    console.log("Name: ",key.info.name);
    console.log("Rating: ",key.info.rating.aggregate_rating);
    console.log("Cost per person: ",key.info.cfo.text);
